    ...
    <aside className="fixed left-0 top-0 h-screen w-[300px] bg-black text-white p-2">
      <nav className="flex flex-col h-full">
        ...
        <div className="space-y-2 mt-2 bg-[#121212] rounded-lg p-2">
          ...
          <Link to="/shows" className="flex items-center space-x-3 p-2 rounded">
            <MdOutlineLiveTv size={24} />
            <span>Shows</span>
          </Link>
          <Link to="/anime" className="flex items-center space-x-3 p-2 rounded">
        ...
        <div className="flex-1 flex flex-col mt-2 bg-[#121212] rounded-lg p-2">
          ...
          <div className="mt-auto">
            {isLoggedIn ? (
              ...
              <button className="flex items-center space-x-3 p-2 rounded w-full">
